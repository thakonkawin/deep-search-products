...
def process_dataset_with_aug_only(input_root="phoom/Train", output_root="train_with_aug_only", augment_per_image=3):
...
# เรียกใช้
process_dataset_with_aug_only("../dataset/Raw/", "../dataset/Train", augment_per_image=5)
