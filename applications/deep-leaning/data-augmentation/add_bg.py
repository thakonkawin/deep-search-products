...
def apply_blurred_random_background(input_path, output_path, bg_folder="bg_phoom", blur_ksize=(81, 81)):
...
def process_dataset_with_blurred_bg(input_root="../dataset/Raw/", output_root="train_with_blurred_bg", bg_folder="bg_phoom"):
...
process_dataset_with_blurred_bg("../dataset/Raw/", "../dataset/Train", "../dataset/BG/")
